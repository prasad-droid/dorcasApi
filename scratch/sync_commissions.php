<?php
require_once 'c:/xampp/htdocs/dorcasApi/api/config/db.php';
...
echo $conn->affected_rows . " vendor_payments records fixed.\n";
...
echo $conn->affected_rows . " bookings records synced.\n";
